...
import { SearchResultItem, SearchResultLink, SearchResultsWrap, SearchResultsProps } from '@redocly/developer-portal/ui';
...
export default function CustomSearchResults(props: SearchResultsProps) {
  ...
  return (
    <StyledSearchResultsWrap show={show} ref={ref}>
      {indexError && process.env.NODE_ENV === 'development' && (
        <Message>
          Faileddd to load search index. Search index is not working in develop. <br />
...
const StyledSearchResultsWrap = styled(SearchResultsWrap)`
  & a {
